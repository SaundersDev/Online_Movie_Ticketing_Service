...
<?php echo '<a href ="customer_homepage.php?username='.$_SESSION["username"].'&fname='.$_SESSION["fname"].'" id = "home">' ?>
	<img src="images/home.png" alt="Home Page" style="width:150px;height:150px;"/>
</a>

<?php echo '<a href ="customer_pastMovies.php?username='.$_SESSION["username"].'&fname='.$_SESSION["fname"].'" id = "home">' ?>
	<img src="images/pastmovies.jpg" alt = "Past Movies" style = "width:150px;height:150px;" />
</a>

<?php echo '<a href ="customer_profile.php?username='.$_SESSION["username"].'&fname='.$_SESSION["fname"].'" id = "home">' ?>
